...
## Diseño visual y UX — Definido por Dulce

Esta sección es responsabilidad de Dulce. Los puntos marcados como pendientes quedan abiertos para que ella los defina con base en su criterio de diseño y experiencia en sistemas computacionales.

### Identidad visual
- [ ] Paleta de colores principal y secundaria
- [ ] Tipografía (fuente para títulos, cuerpo, datos numéricos)
- [ ] Estilo de iconografía
- [ ] Tema: oscuro / claro / adaptable al sistema
- [ ] Nombre visual del proyecto (cuando se defina el nombre final)

### UX y flujos detallados
- [ ] Wireframes de cada pantalla principal
- [ ] Comportamiento en estados vacíos (sin dispositivos, sin diagnósticos, sin lecturas)
- [ ] Comportamiento en errores (sin conexión, timeout del backend, fallo de ARGOS)
- [ ] Animaciones y transiciones entre pantallas
- [ ] Feedback visual al usuario (loaders, toasts, confirmaciones)

### Decisiones de diseño pendientes
- [ ] ¿Cómo se muestra el bounding box de ARGOS sobre la foto? (color, grosor, etiqueta)
- [ ] ¿Cómo se edita la lista de componentes? (inline, modal, swipe to delete)
- [ ] ¿Cómo se visualiza el estado Normal / Advertencia / Crítico? (color, ícono, banner)
- [ ] ¿Los gauges del monitor son circulares, lineales o mixtos?
- [ ] Esquema de notificaciones push (diseño del mensaje de alerta)

### Recursos
- Herramienta sugerida para wireframes: Figma
- Herramienta sugerida para prototipo interactivo: Figma o v0.dev
- Referencia de componentes Flutter: [Material 3](https://m3.material.io/)
